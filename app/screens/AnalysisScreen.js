...
function AnalysisScreen(props) {
  ...
  */
  ...
  const eventHandler = () => {
    ...
    if (hexObj.trigramBg == "chien_Heaven") setTrigramBg(chien_Heaven);
    else if (hexObj.trigramBg == "chen_Thunder") setTrigramBg(chen_Thunder);
    else if (hexObj.trigramBg == "kan_Water") setTrigramBg(kan_Water);
    else if (hexObj.trigramBg == "kun_Earth") setTrigramBg(kun_Earth);
    else if (hexObj.trigramBg == "ken_Mountain") setTrigramBg(ken_Mountain);
    else if (hexObj.trigramBg == "li_Fire") setTrigramBg(li_Fire);
    else if (hexObj.trigramBg == "sun_wind") setTrigramBg(sun_Wind);
    else if (hexObj.trigramBg == "tui_Lake") setTrigramBg(tui_Lake);

    for (var item in hexChar) {
  ...
  return (
    ...
    >
      <ImageBackground source={trigramBg} style={styles.backgroundImage}>
        <View style={{ flex: 0.5, paddingHorizontal: 20 }}>
          <View style={{ flex: 1, alignItems: "flex-start" }}>
            ...
            >
              {chinaHexagram + " - " + hexagram + "  -  " + UpperTriMeaning}
            </Text>
            <Text
              style={{
                color: "#000000",
            ...
            >
              {" "}
              {"Above:  " + UpperTriName + "  -  " + UpperTriMeaning}
            </Text>
            <Text
              style={{
                color: "#000000",
            ...
            >
              {" "}
              {"Below:  " + LowerTriName + "  -  " + LowerTriMeaning}
            </Text>
          </View>
        ...
        >
          <ScrollView>
            ...
            <Text style={styles.hexBody}>{hexagramJudgement}</Text>

            <Text style={styles.hexTitle}>The Image</Text>
            <Text style={styles.hexBody}>{hexagramIMG}</Text>

            <Text style={styles.hexTitle}>The Lines</Text>
            <Text style={styles.hexBody}>{hexagramLines}</Text>
          </ScrollView>
        </View>
      ...
      <Image
        source={triHexRow}
        style={{ height: 30, width: 400, paddingBottom: 10, paddingTop: 10 }}
      />
    </SafeAreaView>
  );
}
